...
async function seedHistoricalDemand() {
  ...
  // Month-by-month historical profile (Month 0 = Oct 2025, ..., Month 10 = Aug 2026)
  // Reflects real relocation seasonality:
  // - Oct/Nov: Festive / Griha Pravesh surge (32-38 moves)
  // - Dec/Jan: Steady lease renewals (16-20 moves)
  // - Feb/Mar: Moderate corporate transfers (18-22 moves)
  // - Apr/May/Jun: Major Summer School & Career relocation peak (30-36 moves)
  // - Jul/Aug: Monsoon period, moderate (12-15 moves)
  ...
  for (const p of monthlyProfiles) {
    for (let i = 0; i < p.count; i++) {
      ...
      // Roughly 75% of historical requests converted to completed/confirmed bookings
